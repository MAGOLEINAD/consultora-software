      ...
      <div className="container mx-auto px-4 md:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-[0.9fr_1.1fr] gap-10 items-start max-w-6xl mx-auto">
          <div>
            ...
            <h2 className="font-display text-3xl md:text-4xl lg:text-5xl font-semibold text-accent mb-5 leading-[1.1]">
              {title}
            </h2>
          ...
          <div>
            <Accordion type="single" collapsible className="space-y-4">
              {items.map((item, index) => (
                ...
                >
                  <AccordionTrigger className="text-left text-accent font-semibold">
                    {item.question}
                  </AccordionTrigger>
