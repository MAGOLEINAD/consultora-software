...
export default function ServiceHero({ icon: Icon, name, shortDescription, imageSrc, locale = 'en' }: ServiceHeroProps) {
  const heroImage =
    imageSrc ||
    'https://images.unsplash.com/photo-1521791136064-7986c2920216?auto=format&fit=crop&w=1400&q=80';
  const detailLabel = locale === 'es' ? 'Detalle del servicio' : 'Service detail';
  const tags = locale === 'es' ? ['Estrategia', 'Implementacion', 'Optimizacion'] : ['Strategy', 'Delivery', 'Optimization'];
